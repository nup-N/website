...
router.post('/auth/register', validation.register, (req, res) => {
  try {
...
// POST /api/auth/login
router.post('/auth/login', loginLimiter, validation.login, (req, res) => {
  try {
...
// PATCH /api/users/:id
router.patch('/users/:id', auth.requireAuth, auth.requireRole('admin', 'super_admin'), validation.updateUser, (req, res) => {
